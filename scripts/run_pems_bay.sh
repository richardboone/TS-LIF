...
function usage() {
    ...
    echo "  OUTPUT_DIR : Destination for logs & checkpoints (Default: outputs/run_pems_bay)"
    echo ""
    echo "Example: $0 6 outputs/my_pems_experiment"
    exit 1
}
...
GPU=${1:-0}
OUT_DIR=${2:-"outputs/run_pems_bay"}

CONFIG_PATH="TS-LIF/exp/forecast/spikegru/local_spikegru_pems-bay.yml"

echo "================================================"
echo "Starting PEMS-BAY Experiment"
echo "  Target GPU     : $GPU"
